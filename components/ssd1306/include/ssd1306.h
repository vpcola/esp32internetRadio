...
/**
* @brief  Draws a bitmap to the STM buffer
* @note   @ref SSD1306_UpdateScreen() must be called after that in order to see updated LCD screen
* @param  x0: X start location for top left corner of the bitmap. Valid input is 0 to SSD1306_WIDTH - 1
* @param  y0: Y start location for top left corner of the bitmap. Valid input is 0 to SSD1306_HEIGHT - 1
* @param  width: the width of the bitmap in pixels
* @param  height: the height of the bitmap in pixels
* @param  xbm: pointer to the bitmap data
* @param  c: Color to be used. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
* @retval None
*/
